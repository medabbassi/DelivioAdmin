...
const ProductForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (role === "admin" && !selectedRestaurant) {
    ...
    try {
      ...
      const restaurantId = localStorage.getItem("restaurantUserId")
      ...
      const myproductData = {
        ...
        productSpecCategory: subCategory,
        productImage: imageUrl,
        restaurantId: restaurantId, // Store the selected restaurant ID
      ...
      } else if (role === "restaurant" || role === "sousrestaurant"){
        await addDoc(collection(db, 'product'), myproductData);
      }
      else {
